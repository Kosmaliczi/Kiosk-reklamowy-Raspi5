...
function setupForms() {
    ...
    saveSettings.addEventListener('click', async () => {
        ...
        const defaultSshUsername = document.getElementById('setting-ssh-username').value;
        ...
        try {
            ...
            // Zapisz domyślnego użytkownika SSH
            ...
            CONFIG.defaultSshPort = sshPort;            CONFIG.defaultFtpPath = ftpPath;
